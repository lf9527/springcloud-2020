...
public class PaymentController {
	...
	public CommonResult create(@RequestBody Payment payment){
		...
		if(result > 0){
			return new CommonResult(200, "create data success 8002", result);
		}
		else{
	...
	public CommonResult getPaymentById(@PathVariable("id") Long id){
		...
		log.info("create result: " + result);
		if(result != null){
			return new CommonResult(200, "get data success 8002", result);
		}
		else{
	...
	public CommonResult getPaymentByIds(@PathVariable("id") Long id){
		...
		return new CommonResult(200, "get data success 8002", serverPort);
	}
}
